...
> Quick convert between hex, rgb, hsl color formats

[![PyPI version](https://badge.fury.io/py/quick-color-convert.svg)](https://pypi.org/project/quick-color-convert/)
...
```bash
pip install quick-color-convert
```

## Quick Start

```python
from quick_color_convert import convert

# Basic usage
result = convert("your input here")
print(result)
```
...
from quick_color_convert import batch
